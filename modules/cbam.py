...
class CBAMLayer(nn.Module):
    """An unofficial implementation of CBAM, proposed in 
    `CBAM: Convolutional Block Attention Module` by Woo et al. at ECCV 2018
    (http://arxiv.org/abs/1807.06521).
    
    Applies a channel and spatial feature maps refinement.
